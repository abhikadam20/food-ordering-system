...
if($_SERVER["REQUEST_METHOD"] == "POST"){
      ...
      $quan =$quantity;
       ...
       if($p_type=="mobile pay"){
        ...
        $next = true;
           $check ="paid";
       }elseif($p_type=="cash on delivery"){
           $pri="paytaype";
        $next = true;
           $check = "none";
       }
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content" style=" background-color: whitesmoke;">
            <div class="modal-header">
                <h3 class="modal-title text-success" id="exampleModalLabel">Order Delivery</h3>
            </div>
            ...
            <?php
             ...
             <h3 class="text-success">Click next button....</h3>
              ...
              <div>';
                        ...
                        echo'<div class="modal-body">
                        <h3 class="text-danger">Sorry this Product is not available. only  <h3 class="text-dark">'.$avli.'</h3> <h3 class="text-danger"> items available ....</h3>
               ...
               <div>
                      ...
                      <button type="sumit" onclick="peet()"  value="cash on delivery" name="submit" class="btn btn-outline-success form-control my-2">Cash on delivery</button>
